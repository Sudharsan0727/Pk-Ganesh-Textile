...
const categories = [
  { id: 1, name: "Shirts & Fabrics", image: "/images/cat_shirts.png" },
  { id: 2, name: "Sarees", image: "/images/cat_saree.png" },
  { id: 3, name: "Dhoti & Cotton Wear", image: "/images/cat_dhoti.png" },
  { id: 4, name: "Towels & Bedsheets", image: "/images/cat_towels.png" },
  { id: 5, name: "Readymade Garments", image: "/images/cat_readymade.png" }
];

const products = [
  { id: 101, name: "Premium Kanchipuram Silk Saree", brand: "Sri Kumaran", price: "Starting ₹2,500", category: "Sarees", image: "/images/cat_saree.png" },
  { id: 102, name: "Formal Cotton Shirt", brand: "Ramraj Cotton", price: "Starting ₹650", category: "Shirts & Fabrics", image: "/images/cat_shirts.png" },
  { id: 103, name: "White Cotton Dhoti with Gold Zari", brand: "Alaya Cotton", price: "Starting ₹450", category: "Dhoti & Cotton Wear", image: "/images/cat_dhoti.png" },
  { id: 104, name: "Luxury Bath Towel Set", brand: "Nandu", price: "Starting ₹300", category: "Towels & Bedsheets", image: "/images/cat_towels.png" },
  { id: 105, name: "Men's Ethnic Wear Sherwani", brand: "Raymond", price: "Starting ₹4,200", category: "Readymade Garments", image: "/images/cat_readymade.png" },
  { id: 106, name: "Casual Linen Shirt", brand: "Uathayam", price: "Starting ₹800", category: "Shirts & Fabrics", image: "/images/cat_shirts.png" },
  { id: 107, name: "Designer Party Wear Saree", brand: "Local Weavers", price: "Starting ₹1,800", category: "Sarees", image: "/images/cat_saree.png" },
  { id: 108, name: "Dhoti and Shirt Combo", brand: "Ramraj Cotton", price: "Starting ₹1,200", category: "Dhoti & Cotton Wear", image: "/images/cat_dhoti.png" }
];
  ...
  return (
    <div className="font-body text-slate-800 bg-accent min-h-screen relative">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 bg-transparent transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex-shrink-0 flex items-center gap-3">
              <img src={logoImg} alt="P.K. Ganesh Tex Logo" className="h-12 md:h-16 w-auto object-contain" />
            </div>
            
            <div className="hidden md:flex gap-8 items-center">
              <a href="#about" className="font-medium text-white hover:text-secondary transition-colors drop-shadow-md">About</a>
              <a href="#categories" className="font-medium text-white hover:text-secondary transition-colors drop-shadow-md">Collections</a>
              <a href="#products" className="font-medium text-white hover:text-secondary transition-colors drop-shadow-md">Shop</a>
              <a href="#contact" className="font-medium text-white hover:text-secondary transition-colors drop-shadow-md">Contact</a>
              <button 
                onClick={() => openWhatsApp()} 
                className="bg-primary hover:bg-primary-dark text-white px-5 py-2.5 rounded-full font-medium transition-all shadow-md flex items-center gap-2"
              >
        ...
        {/* Mobile menu */}
        {isMenuOpen && (
          <div className="md:hidden absolute w-full bg-accent border-b border-secondary shadow-lg">
      ...
      <section 
        id="home" 
        className="relative pt-20 pb-32 lg:pt-32 lg:pb-48 overflow-hidden min-h-screen flex items-center"
      >
        <AnimatePresence>
          <motion.div
            key={currentSlide}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full h-full flex flex-col justify-center">
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className="max-w-4xl text-white mt-12 md:mt-0"
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap gap-4 mb-10 md:mb-0">
                <a href="#categories" className="bg-secondary hover:bg-yellow-600 text-slate-900 px-8 py-3.5 rounded-full font-semibold transition-all shadow-lg text-base">
                  Browse Collection
                </a>
                <button onClick={() => openWhatsApp()} className="bg-[#25D366] hover:bg-[#1ebd59] text-white px-8 py-3.5 rounded-full font-semibold transition-all shadow-lg text-base flex items-center gap-2">
          ...
          {/* Slider Indicators */}
          <div className="absolute bottom-[-20px] md:bottom-[-60px] left-0 flex gap-3 z-20">
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-accent relative z-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <h2 className="text-4xl font-heading font-bold text-primary mb-6">Our Legacy</h2>
            ...
            <p className="text-xl leading-relaxed text-slate-700 font-medium">
              "P.K. Ganesh Tex is a trusted wholesale textile trader in Madurai offering high-quality fabrics, garments, and accessories from leading brands. We combine cultural heritage with modern weaving techniques to bring you the best in South Indian textiles."
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {categories.map((cat, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-end pb-8">
                  <h3 className="text-2xl font-heading font-bold text-white drop-shadow-md text-center px-4">{cat.name}</h3>
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              <button 
                ...
                className={`px-6 py-2 rounded-full font-medium transition-all ${activeTab === "All" ? "bg-primary text-white shadow-md" : "bg-white text-slate-700 hover:bg-slate-100 border border-slate-200"}`}
              >
                All
              </button>
              {categories.map(cat => (
                <button 
                  ...
                  className={`px-6 py-2 rounded-full font-medium transition-all ${activeTab === cat.name ? "bg-primary text-white shadow-md" : "bg-white text-slate-700 hover:bg-slate-100 border border-slate-200"}`}
                >
                  {cat.name}
                </button>
              ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {filteredProducts.map((product, i) => (
              <motion.div 
                ...
                className="bg-white rounded-2xl overflow-hidden shadow-default hover:shadow-xl transition-all group flex flex-col h-full border border-slate-100"
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <h3 className="text-xl font-heading font-bold text-slate-900 mb-2 line-clamp-2">{product.name}</h3>
